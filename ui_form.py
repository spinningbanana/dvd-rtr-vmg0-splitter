...
class Ui_Splitter(object):
    def setupUi(self, Splitter):
        ...
        self.meta_version.setGeometry(QRect(280, 500, 211, 20))
        ...
        self.meta_copyright.setGeometry(QRect(50, 500, 211, 20))
        ...
        self.meta_copyright.setIndent(0)
    ...
    def retranslateUi(self, Splitter):
        ...
        self.meta_version.setText(QCoreApplication.translate("Splitter", u"v1.0.0", None))
